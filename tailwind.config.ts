  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "page-turn-next": {
          "0%": { opacity: "0", transform: "translateX(28px) rotateY(-6deg) scale(0.98)" },
      ...
      animation: {
        ...
        "page-turn-next": "page-turn-next 0.35s var(--ease-out-soft) both",
        "page-turn-prev": "page-turn-prev 0.35s var(--ease-out-soft) both",
      },
    },
  },
